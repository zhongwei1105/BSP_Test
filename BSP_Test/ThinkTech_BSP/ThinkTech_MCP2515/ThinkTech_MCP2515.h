...
/*****************************************************************************************
								Macro definitions
*****************************************************************************************/
#define MCP2515_INT_PIN					4		//GPIO4
#define MCP2515_INT_READ() 				GPIO_PinRead(MCP2515_INT_PIN) 
#define MCP2515_INT_TYPE				INT_TYPE_FALLING_EDGE
#define MCP2515_INT_IRQn				GPIO4_IRQn
#define MCP2515_INT_IRQHandler			GPIO4_IRQHandler

#define POLARITY_CONFIG    				ARM_SPI_CPOL1_CPHA1
#define TRANSFER_SPEED     				2000000

#define Std_ID							0
#define Ext_ID							1

#define Std_Send_ID						0x7DF			// CAN发送标准ID
#define Std_Receive_ID					0x7E8			// CAN接收过滤标准ID
#define Std_Receive_Filter				0x7E0			// CAN接收屏蔽标准ID

#define Ext_Send_ID						0x18DB33F1		// CAN发送扩展ID
#define Ext_Receive_ID					0x18DAF110		// CAN接收过滤扩展ID
#define Ext_Receive_Filter				0x1FFFF100		// CAN接收屏蔽扩展ID
...
*****************************************************************************************/
extern void MCP2515_Init(uint8_t CANStype, uint8_t velocity);
extern void MCP2515_WriteByte(unsigned char addr,unsigned char dat);
